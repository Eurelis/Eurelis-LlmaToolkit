...
# from langchain.schema import BaseDocumentTransformer, # TODO Trouver equivalent

from llama_index.core import Document
from llama_index.core.text_splitter import TokenTextSplitter

from eurelis_llmatoolkit.llamaindex.utils.base_factory import JSON
from eurelis_llmatoolkit.llamaindex.types import PARAMS

# from eurelis_llmatoolkit.langchain.document_transformers.base import (
#     BaseIteratorDocumentTransformer,
# ) # TODO Trouver equivalent
...
class TemplateTextDocWrapper:
    ...
    def __getitem__(self, key: str):
        if key == "page_content":
            return self.document.text  # TODO : Tester si page_content ou text
...
class Dataset(BaseReader):
    ...
    def __init__(self, dataset_id: str, loader: BaseReader):
        ...
        self.id = dataset_id
        self.loader = loader
        self.splitter: Optional[TokenTextSplitter] = None
        # TODO : Trouver equivalent
        ...
        self.vector_store: Optional["VectorStoreIndex"] = None
    ...
    def set_splitter(self, splitter: "TokenTextSplitter"):
        """
        Setter for the splitter
        Args:
            splitter: a TokenTextSplitter instance
    ...
    def load_document_from_cache(path: str) -> Document:
        ...
        with open(path) as json_file:
            ...
            return Document(
                text=page_content, metadata=metadata
            )  # TODO : Il y a une erreur mais normalement metadata existe
    ...
    def _lazy_load_transformer(self) -> Iterable[Document]:
        ...
        try:
            documents = self.loader.lazy_load_data()
