...
from eurelis_llmatoolkit.llamaindex.types import JSON, PARAMS
...
class DefaultFactories(Enum):
    # DOCUMENT_LOADER = (
    #     "eurelis_llmatoolkit.llamaindex.document_loaders",
    #     "GenericLoaderFactory",
    # )
    # SPLITTER = (
    #     "eurelis_llmatoolkit.llamaindex.text_splitters",
    #     "GenericTextSplitterFactory",
    # )
    # TRANSFORMER = (
    #     "eurelis_llmatoolkit.llamaindex.document_transformers",
    #     "GenericDocumentTransformersFactory",
    # )
    # VECTORSTORE = (
    #     "eurelis_llmatoolkit.llamaindex.vectorstores",
    #     "GenericVectorStoreFactory",
    # )
    # LLM = ("eurelis_llmatoolkit.llamaindex.llms", "GenericLLMFactory")
    # CHAIN = ("eurelis_llmatoolkit.llamaindex.chains", "GenericChainsFactory")
    # EMBEDDINGS = (
    #     "eurelis_llmatoolkit.llamaindex.embeddings",
    #     "GenericEmbeddingsFactory",
    # )
    # MEMORY = ("eurelis_llmatoolkit.llamaindex.memory", "GenericMemoryFactory")
    # ACRONYMS = (
    #     "eurelis_llmatoolkit.llamaindex.acronyms",
    #     "AcronymsTextTransformerFactory",
    # )
    # RETRIEVER = ("eurelis_llmatoolkit.llamaindex.retrievers", "GenericRetrieverFactory")
